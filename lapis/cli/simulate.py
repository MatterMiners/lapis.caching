...
from lapis.storageelement import StorageElement, HitrateStorage, FileBasedHitrateStorage
...
"""Simulation CLI, pay attention to the fact that the random seed is currently set to a fixed value"""
